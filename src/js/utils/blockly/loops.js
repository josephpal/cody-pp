...
Blockly.Cpp['start'] = function(block) {
  ...
  var code = "#include \"ft_ESP32_IOobjects.h\"\n\n"
	+ "enum Motor {Motor_0, Motor_1, Motor_2, Motor_3};\n\n"
	+ "enum Lampe {Lampe_0, Lampe_1, Lampe_2, Lampe_3};\n\n"
	+ "enum Digital_Ports {Digital_0, Digital_1, Digital_2, Digital_3,\n"
  ...
  + "enum Analog_Ports {Analog_0, Analog_1, Analog_2, Analog_3,\n"
  ...
  + "// \n"
	+ "Motor mMotor;\n" + "Lampe mLampe;\n" + "Digital_Ports mDigital_Ports;\n" + "Analog_Ports mAnalog_Ports;\n" +  "\n"
	+ "int main() {\n"
  ...
  + Blockly.Cpp.INDENT + Blockly.ArduinoCpp.INDENT + "mLampeArray[i] = Lampe(i);\n"
  + Blockly.Cpp.INDENT + "}\n\n"
...
Blockly.ArduinoCpp['start'] = function(block) {
  ...
  + "Motor mMotorArray[MOTOR_QTY];\n" + "Lampe mLampeArray[LAMP_QTY];\n" + "DigitalAnalogIn mDAIn[DAIN_QTY];\n\n"
	+ "// setup enum\n"
	+ "Motor mMotor;\n" + "Lampe mLampe;\n" + "Digital_Ports mDigital_Ports;\n" + "Analog_Ports mAnalog_Ports;\n" + "\n" + "void setup() {\n"
  + Blockly.ArduinoCpp.INDENT + "Serial.begin(9600);\n\n"
  ...
  + Blockly.ArduinoCpp.INDENT + Blockly.ArduinoCpp.INDENT + "mLampeArray[i] = Lampe(i);\n"
  + Blockly.ArduinoCpp.INDENT + "}\n\n"
